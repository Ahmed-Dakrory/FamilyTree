...
import main.com.familyTree.security.AuthenticationService;
...
public class loginBean  {
	...
	public void login(int account){
		...
		if(isLoggedIn){
			...
			if(account==user.GoogleAccount) {
				 success = authenticationService.autoLogin(theUserOfThisAccount.getEmail(), passwordOfUserLoggedIn);
				
			}else {

				 success = authenticationService.login(theUserOfThisAccount.getEmail(), passwordOfUserLoggedIn);
			}
						if (success) {
